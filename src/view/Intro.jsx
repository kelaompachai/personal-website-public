  ...
  return (
    <div className="flex text-lg font-light">
      ...
      <div className="flex flex-col items-center">
        ...
        <a className="text-blue-700 underline" href="https://www.github.com/kelaompachai">Github</a>
        <a className="text-blue-700 underline" href="https://www.linkedin.com/in/joseph-lawrence-paul">LinkedIn</a>
      </div>
    </div>
  );
}
